...
At this time, we recommend preferring to use [`s5cmd`](../../data_management/storage/lts/interfaces.md#s5cmd) to transfer large amounts of data into and out of LTS.
