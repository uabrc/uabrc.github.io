...
We review accounts periodically to ensure the system is being used fairly and as intended. Part of this process is to certify that researchers with accounts still wish to make use of Cheaha. Once per year every researcher will be required to certify their account before making use of Cheaha. In addition, an account may also require certification after it has been placed on hold (see our [Account on Hold section](#account-on-hold)). This ensures that you, the user, are engaged in the process of reactivating your account to use our resources. If your account requires certification, when logging in to our [Open OnDemand](../cheaha/open_ondemand/index.md) web portal you will see the following notification page.
