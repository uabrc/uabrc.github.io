...
1. Access the terminal following the steps in the [Installing Anaconda Environments Using the Terminal section](#installing-anaconda-environments-using-the-terminal).
