...
$ wc -l $HOME/input_files/random_file_2.txt
3 $HOME/input_files/random_file_2.txt
```
...
```bash
### Listing all the output log files generated by the Slurm
$ ls $HOME/example_4/logs/dynamic_file_word_count*.out
