...
Use of these software packages without authorization may be a violation of the [UAB IT Acceptable Use Policy](../../policies.md#acceptable-use-policy-aup). All restrictively licensed software may only used for the purposes of teaching and research, and not for commercial use or for profit.
