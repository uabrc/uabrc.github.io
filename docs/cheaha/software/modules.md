...
To begin, all module commands are run from the [terminal](../open_ondemand/ood_layout.md#terminal). To know what software is installed on Cheaha, use the `avail` command.
