...
The setup process for [cloud.rc](index.md) is more involved than for [Cheaha](../cheaha/index.md). Before using cloud.rc for Jupyter Notebooks, be sure that [Open OnDemand on Cheaha](../cheaha/open_ondemand/ood_interactive.md#jupyter-notebook) does not meet your needs.
