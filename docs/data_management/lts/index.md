...
!!! danger
    ...
    Never give access and secret keys for personal or lab allocations to anyone! Bad actors who are given keys to allocations which own important buckets can change access permissions and delete any and all data!
